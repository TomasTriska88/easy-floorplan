    ...
    <defs>
      <mask id=${id} maskUnits="userSpaceOnUse"
        ...
        ${furniture.map((f) => {
          ...
          return renderFurnitureMask(f, "#000", "#000", blocked);
          // return renderSymbolParts(findSymbol(catalog, f.type) ?? FALLBACK_SYMBOL, f.w, f.h, "black")
          // return buildSvgOutline(furniture);
          return roundBase
