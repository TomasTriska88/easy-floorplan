 ...
 *
 * This is intentionally a standalone prototype renderer. It is not imported by
 * `render.ts` or `floorplan-card.ts` yet, so merely adding this module cannot
 * alter an existing card. When wired later, the host should place this group
 * above the Area floor fill and below direct sunlight, glows, openings and
 * interactive items.
 */
